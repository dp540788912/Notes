...
master has progressed when you are on a feature branch, but you want to get new updates of master 

```
         --> f1 --> f2 --> f3      <-- Feature(you)
        /
m1 --> m2 --> m3 --> m4      <-- Master

```

In the diagram above, you want to introduce m3 and m4 to feature, but you want a clean and linear history do 
...
this operation will transform history to:
...
with -i parameter, git gives you freedom to customize your branch commits, such as sqush, fixup and etc.

forward to git rebase -i
